...
if __name__ == '__main__':
    ...
    if map_type == 'Borregas_ave' :
    	...
    	routing_2_x = 444986.63   #first lane: 444996.08,second lane:444986.63
    	routing_2_y = 6185779.9 # first lane: 6185778.55,second lane:6185779.9	
  ...
  #  start_x = vehicle_pos_x
    ...
    initial_x3 = routing_1_x + math.cos(theta) * (starting_distance + 50 )# initial position of obstacle
    initial_y3 = routing_1_y + math.sin(theta) * (starting_distance + 50 )# initial position of obstacle
    old_x3= initial_x3
    old_y3= initial_y3
    delta_width = 3.4
    ...
    initial_x6 = routing_1_x + math.cos(theta) * (starting_distance +50 )# initial position of obstacle
    initial_y6 = routing_1_y + math.sin(theta) * (starting_distance +50 )# initial position of obstacle
    old_x6= initial_x6
    old_y6= initial_y6
