...
class STObstaclesProcessor {
 public:
  ...
  common::Status MapObstaclesToSTBoundaries(PathDecision* const path_decision,bool is_in_path_lane_borrow_scenario,std::string overtake_obstacle_id);
 ...
 private:
  ...
  bool ComputeObstacleSTBoundary(const Obstacle& obstacle,
                                 ...
                                 bool is_in_path_lane_borrow_scenario, std::string overtake_obstacle_id);
