...
if __name__ == '__main__':
  ...
  #  start_x = vehicle_pos_x
    ...
    initial_x4 = routing_1_x + math.cos(theta) * (starting_distance -60 )# initial position of obstacle
    initial_y4 = routing_1_y + math.sin(theta) * (starting_distance -60 )# initial position of obstacle
    old_x4= initial_x4
    old_y4= initial_y4
    
    initial_x5 = routing_1_x + math.cos(theta) * (starting_distance -60 )# initial position of obstacle
    initial_y5 = routing_1_y + math.sin(theta) * (starting_distance -60 )# initial position of obstacle
    old_x5= initial_x5
    old_y5= initial_y5
    
    initial_x6 = routing_1_x + math.cos(theta) * (starting_distance -70 )# initial position of obstacle
    initial_y6 = routing_1_y + math.sin(theta) * (starting_distance -70 )# initial position of obstacle
    old_x6= initial_x6
    old_y6= initial_y6
    ...
    while not cyber.is_shutdown():
     #   print('publishing obstacles')
        ...
        obstacle4.position.x = old_x4 + math.cos(theta) * delta_s4 - math.sin(theta) * 2 * delta_width
        obstacle4.position.y = old_y4 + math.sin(theta) * delta_s4 + math.cos(theta) * 2 * delta_width
        obstacle4.position.z = 0
        old_x4 = old_x4 + math.cos(theta) * delta_s4 
        old_y4 = old_y4 + math.sin(theta) * delta_s4
        
        obstacle4.velocity.x = math.cos(theta) * speed4
        obstacle4.velocity.y = math.sin(theta) * speed4
        ...
        obstacle5.position.x = old_x5 + math.cos(theta) * delta_s5 - math.sin(theta) * 4 * delta_width
        obstacle5.position.y = old_y5 + math.sin(theta) * delta_s5 + math.cos(theta) * 4 * delta_width
        obstacle5.position.z = 0
        old_x5 = old_x5 + math.cos(theta) * delta_s5 
        old_y5 = old_y5 + math.sin(theta) * delta_s5
        
        obstacle5.velocity.x = math.cos(theta) * speed5
        obstacle5.velocity.y = math.sin(theta) * speed5
        ...
        obstacle6.id = 6
        obstacle5.theta = theta   # in radian
        obstacle6.position.x = old_x6 + math.cos(theta) * delta_s6 - math.sin(theta) * 6 * delta_width
        obstacle6.position.y = old_y6 + math.sin(theta) * delta_s6 + math.cos(theta) * 6 * delta_width
        obstacle6.position.z = 0
        old_x6 = old_x6 + math.cos(theta) * delta_s6 
        old_y6 = old_y6 + math.sin(theta) * delta_s6
        
        obstacle6.velocity.x = math.cos(theta) * speed6
        obstacle6.velocity.y = math.sin(theta) * speed6
