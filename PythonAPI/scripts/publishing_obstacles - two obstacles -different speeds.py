...
if __name__ == '__main__':
    ...
    if map_type == 'Borregas_ave' :
    	...
    	routing_2_x = 444996.08   #first lane: 444996.08,second lane:444986.63 , third lane:
    	routing_2_y = 6185778.55 # first lane: 6185778.55,second lane:6185779.9, third lane: 	
  ...
  #  start_x = vehicle_pos_x
    ...
    while not cyber.is_shutdown():
     #   print('publishing obstacles')
        ...
        obstacle3.position.x = old_x3 + math.cos(theta) * delta_s3 - math.sin(theta) * delta_width
        obstacle3.position.y = old_y3 + math.sin(theta) * delta_s3 + math.cos(theta) * delta_width
        obstacle3.position.z = 0
        old_x3 = old_x3 + math.cos(theta) * delta_s3 
        old_y3 = old_y3 + math.sin(theta) * delta_s3
        
        obstacle3.velocity.x = math.cos(theta) * speed3
        obstacle3.velocity.y = math.sin(theta) * speed3
