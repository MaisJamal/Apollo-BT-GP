...
MAX_EGO_SPEED = 16.66 # (60 km/h, 25 mph)
SPEED_VARIANCE = 10 # Simple Physics does not return an accurate value
MAX_POV_SPEED = 5 # (2.5 m/s == 9 km/h, 20 mph)
MAX_POV_ROTATION = 5 #deg/s
TIME_LIMIT = 360 # seconds
TIME_DELAY = 3
MAX_FOLLOWING_DISTANCE = 20 #50 # Apollo 3.5 is very cautious
...
# 
egoState.transform.position = spawns[0].position + 115.0 * forward - 3.0 * right#6.5 * right
...
POVState.transform.position = spawns[0].position + 140.0 * forward - 3.0 * right
